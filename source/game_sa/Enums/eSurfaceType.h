...
enum eSurfaceType : uint8 {
    ...
    /* Number of regular surface types */
    TOTAL_NUM_SURFACE_TYPES,

    /* Special surface types used for the Audio Engine for collisions */
    AE_SURFACE_TYPE_BMX            = 188,
    AE_SURFACE_TYPE_MOLOTOV        = 189,
    AE_SURFACE_TYPE_SATCHEL_CHARGE = 190,
    AE_SURFACE_TYPE_GRENADE        = 191,
    AE_SURFACE_TYPE_POOL_BALL      = 192,
    AE_SURFACE_TYPE_BASKETBALL     = 193,
    AE_SURFACE_TYPE_PUNCHBAG       = 194,

    /* Total surface types for collision */
    TOTAL_NUM_COLLISION_SURFACE_TYPES,
};
